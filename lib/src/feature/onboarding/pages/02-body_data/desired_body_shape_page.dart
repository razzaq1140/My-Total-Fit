...
class DesiredBodyShapePage extends StatefulWidget {
  const DesiredBodyShapePage({super.key});

  @override
  State<DesiredBodyShapePage> createState() => _DesiredBodyShapePageState();
}

class _DesiredBodyShapePageState extends State<DesiredBodyShapePage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: const PreferredSize(
          ...
          child: CustomProgressBar(currentStep: 2, totalSteps: 10),
        ),
      ),
            ...
            children: [
              ...
              Consumer<OnboardingProvider>(
                builder: (context, provider, child) => CustomAnimatedButton(
                  onTap: () {
                    context.pushNamed(AppRoute.currentHeight);
                    provider.updateDesiredBodyShape(
